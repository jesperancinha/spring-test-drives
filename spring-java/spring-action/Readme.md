...
1.  AOP - [spring-action-aop](./spring-action-aop)

`@Aspect`, `perthis`, `@Scope`, `prototype`, `@Before`
`@Pointcut`, `@Before`
`!`, `||`, `&&`

2.  MVC - [spring-action-mvc](./spring-action-mvc)

`@PathVariable`, `@RequestParam`, `Principal`, `ServletRequest`

3.  Security - [spring-action-security](./spring-action)
4.  JPA - Spring - Data - [spring-action-data](./spring-action-data)
...
5.  Boot - Intro - [spring-action-boot](./spring-action-boot)
6.  AutoConfig - [spring-action-auto-config](./spring-action-auto-config)
7.  Actuator - [spring-action-actuator](./spring-action-actuator)
...
8.  Testing - [spring-action-testing](./spring-action-testing)

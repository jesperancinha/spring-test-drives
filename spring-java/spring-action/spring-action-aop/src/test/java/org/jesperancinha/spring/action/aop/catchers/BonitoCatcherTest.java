...
class BonitoCatcherTest {
    ...
    void testCatchWithNetWhenCalledThenTriggerAllAdvices() {
        ...
        assertThat(joinPointArgumentCaptorValue.getSignature().toString()).isEqualTo("Bonito org.jesperancinha.spring.action.aop.catchers.BonitoCatcher.catchWithNet()");
    }
    ...
    void testCatchWithFishingPoleWhenCalledThenTriggerAllAdvices() {
        ...
        verify(bonito2Service, only()).beforeAnyCatch(joinPointArgumentCaptor.capture());
        final var joinPointArgumentCaptorValue = joinPointArgumentCaptor.getValue();
        assertThat(joinPointArgumentCaptorValue.getSignature().toString()).isEqualTo("Bonito org.jesperancinha.spring.action.aop.catchers.BonitoCatcher.catchWithFishingPole()");
    }
    ...
    void testCatchByHandWhenCalledThenTriggerAllAdvices() {
        ...
        verify(bonito2Service, only()).beforeAnyCatch(joinPointArgumentCaptor.capture());
        final var joinPointArgumentCaptorValue = joinPointArgumentCaptor.getValue();
        assertThat(joinPointArgumentCaptorValue.getSignature().toString()).isEqualTo("Bonito org.jesperancinha.spring.action.aop.catchers.BonitoCatcher.catchByHand()");
    }
    ...
    void testCatchByHandExtraWhenCalledThenTriggerAllAdvices() {
        ...
        verify(bonito2Service, only()).beforeAnyCatch(joinPointArgumentCaptor.capture());
        final var joinPointArgumentCaptorValue = joinPointArgumentCaptor.getValue();
        assertThat(joinPointArgumentCaptorValue.getSignature().toString()).isEqualTo("void org.jesperancinha.spring.action.aop.catchers.BonitoCatcher.catchByHandExtra()");
    }
    ...
    void testCatchWithClawsWhenCalledThenTriggerAllAdvices() {
        ...
        assertThat(allValues.stream()
                ...
                .map(Object::toString))
                .contains("Bonito org.jesperancinha.spring.action.aop.catchers.BonitoCatcher.catchWithClaws()", "Bonito org.jesperancinha.spring.action.aop.catchers.BonitoCatcher.catchWithClaws()");
    }
    ...
    void testCatchWithSuperSonicWavesWhenCalledThenTriggerAllAdvices() {
        ...
        verify(bonito2Service, only()).beforeAnyCatch(joinPointArgumentCaptor.capture());
        final var joinPointArgumentCaptorValue = joinPointArgumentCaptor.getValue();
        assertThat(joinPointArgumentCaptorValue.getSignature().toString()).isEqualTo("Bonito org.jesperancinha.spring.action.aop.catchers.BonitoCatcher.catchWithSuperSonicWaves()");
    }
    ...
    void testCatchWithABucketWhenCalledThenTriggerAllAdvices() {
        ...
        verify(bonito2Service, only()).beforeAnyCatch(joinPointArgumentCaptor.capture());
        final var joinPointArgumentCaptorValue = joinPointArgumentCaptor.getValue();
        assertThat(joinPointArgumentCaptorValue.getSignature().toString()).isEqualTo("Bonito org.jesperancinha.spring.action.aop.catchers.BonitoCatcher.catchWithABucket()");
    }
    ...
    void testCatchWithLoveWhenCalledThenTriggerAllAdvices() {
        ...
        verify(bonito2Service, only()).beforeAnyCatch(joinPointArgumentCaptor.capture());
        final var joinPointArgumentCaptorValue = joinPointArgumentCaptor.getValue();
        assertThat(joinPointArgumentCaptorValue.getSignature().toString()).isEqualTo("Bonito org.jesperancinha.spring.action.aop.catchers.BonitoCatcher.catchWithLove()");
    }
}
...
import org.jesperancinha.spring.action.aop.beans.OysterService
import org.jesperancinha.spring.action.aop.model.Oyster
import org.jesperancinha.spring.action.aop.pickers.OysterPicker
...
internal class OysterAspectKotlinTest @Autowired constructor(
    ...
    fun testOysterProcessing() {
        ...
        joinPointArgumentSlot
            ...
            .first()
            .signature
            .toString() shouldBe "Oyster org.jesperancinha.spring.action.aop.pickers.OysterPicker.pickup(Oyster)"
    }
    ...
    fun testOysterQualityProcessing() {
        ...
        joinPointArgumentSlot
            .shouldNotBeNull()
            .first().signature
            .toString() shouldBe "Oyster org.jesperancinha.spring.action.aop.pickers.OysterPicker.pickWithQuality(Oyster)"
    }
}
...
import org.jesperancinha.spring.action.aop.beans.GambaService;
...
public class GambaAspect {
    ...
    @Before("execution(public * org.jesperancinha.spring.action.aop.catchers.GambaFoodCatcher.*()) " +
            "&& within(org.jesperancinha.spring.action.aop.catchers.G*))")
    public void beforeWithin(final JoinPoint joinPoint) {
        gambaService.beforeWithin(joinPoint);
    }

    @Before("execution(public * org.jesperancinha.spring.action.aop.catchers.GambaFoodCatcher.catchByHand()) " +
            "&& @annotation(org.jesperancinha.spring.action.aop.annotations.Master))")
    public void beforeWithinNoAtAnnotation(final JoinPoint joinPoint) {
        gambaService.beforeWithinNoAtAnnotation(joinPoint);

    }

    @Before("@within(org.jesperancinha.spring.action.aop.annotations.Master)")
    public void beforeWithinAnnotation(final JoinPoint joinPoint) {
        gambaService.beforeWithinAnnotation(joinPoint);
    }

    @Before("execution(@org.jesperancinha.spring.action.aop.annotations.Master public * org.jesperancinha.spring.action.aop.catchers.GambaFoodCatcher.*()))")
    public void beforeExecution(final JoinPoint joinPoint) {
        gambaService.beforeExecution(joinPoint);
    }

    @Before("@annotation(org.jesperancinha.spring.action.aop.annotations.Master)")

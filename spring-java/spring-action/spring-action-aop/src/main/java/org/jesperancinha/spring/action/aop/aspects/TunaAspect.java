...
import org.jesperancinha.spring.action.aop.catchers.TunaCatcher;
...
public class TunaAspect {
     ...
     */
    @Before("execution(public * org.jesperancinha.spring.action.aop.catchers.TunaCatcher+.catchWithNet())")

...
@Aspect("perthis(execution(public void org.jesperancinha.spring.action.aop.catchers.BonitoCatcher.catchByHandExtra()))")
//@Aspect
@Component
@Scope("prototype")
public class BonitoAspect {
     ...
     */
    @Before("execution(public org.jesperancinha.spring.action.aop.model.Bonito org.jesperancinha.spring.action.aop.catchers.BonitoCatcher.catchByHand())")
    public void waitForFishCatch() {
        bonito1Service.waitForFishCatch();
    }

    @Before("execution(public void org.jesperancinha.spring.action.aop.catchers.BonitoCatcher.catchByHandExtra())")

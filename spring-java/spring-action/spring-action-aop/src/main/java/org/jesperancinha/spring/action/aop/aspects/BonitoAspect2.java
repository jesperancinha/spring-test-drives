...
public class BonitoAspect2 {
    ...
    @Pointcut("execution(public org.jesperancinha.spring.action.aop.model.Bonito org.jesperancinha.spring.action.aop.catchers.BonitoCatcher.catchWithClaws())")
    ...
    @Before("execution(public * org.jesperancinha.spring.action.aop.catchers.BonitoCatcher.catch*()) && !@within(org.jesperancinha.spring.action.aop.annotations.Master)")

package org.jesperancinha.spring.mastery2.portuguese.music.configuration;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        return http.authenticationProvider(new Mastery2AuthenticationProvider())
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/portuguese/antonio").authenticated()
                        .requestMatchers("/portuguese").permitAll()
                )

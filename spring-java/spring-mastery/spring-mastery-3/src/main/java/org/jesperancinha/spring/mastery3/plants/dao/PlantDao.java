...
public class PlantDao {
    ...
    public synchronized Plant createPlant(final Plant plant) {
        ...
        jdbcTemplate.execute("create table if not exists plant(" +
                ...
                ")");
        try {
            final int update = jdbcTemplate.update("insert into plant(name, scientificName) values  (? , ? )", plant.getName(), plant.getScientificName());

package org.jesperancinha.spring.flash214.transactions.services
...
@SpringBootTest
@ActiveProfiles("emb")
@ComponentScan("org.jesperancinha.spring.flash214.transactions", "org.jesperancinha.spring.flash214.transactions.services")
@Sql(executionPhase = ExecutionPhase.BEFORE_TEST_METHOD, scripts = ["classpath:schema.sql"])
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
internal class CarRepeatableReadDAOKotlinTest @Autowired constructor(

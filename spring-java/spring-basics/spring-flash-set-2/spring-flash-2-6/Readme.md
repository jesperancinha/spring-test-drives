...
Exploring RowMapper and ResultSetExtractor as callbacks in Spring

Topics

1.  `RowMapper`, `ResultSetExtractor`
...
-   [Conquilha](https://pt.wikipedia.org/wiki/Conquilha)
-   [Berbigão](https://pt.wikipedia.org/wiki/Berbig%C3%A3o)
-   [Cerastoderma edule](https://pt.wikipedia.org/wiki/Cerastoderma_edule)

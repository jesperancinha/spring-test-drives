...
1.  [spring-flash-1](./spring-flash-1) - 🍋 PropertyEditorRegistrar and converters + 🌱 AOP (Aspect Oriented Programming)
2.  [spring-flash-3](./spring-flash-3) - ⛴ JDBC with boats
3.  [spring-flash-4](./spring-flash-4) - 🪄 Spring param converters
4.  [spring-flash-5](./spring-flash-5) - 🥔 Sequence generator with potatoes
5.  [spring-flash-6](./spring-flash-6) - 🧮 Keep the math in the Session
6.  [spring-flash-7](./spring-flash-7) - 🏎 🌺 Exception handling with cars and flowers
7.  [spring-flash-8](./spring-flash-8) - 🎄 Xmas message with simple JSP in Spring
8.  [spring-flash-9](./spring-flash-9) - 🤖 A very simple bot with SockJS support
9.  [spring-flash-10](./spring-flash-10) - 🛑 Error messages
10. [spring-flash-11](./spring-flash-11) - 👔 Form parameters
11. [spring-flash-12](./spring-flash-12) - 🔑 CORS explained via annotations
12. [spring-flash-13](./spring-flash-13) - 🗄 GZipping Static Resources
13. [spring-flash-14](./spring-flash-14) - 🏠 Health Indicators
14. [spring-flash-15](./spring-flash-15) - 🧑‍🎤 Type safe configuration
15. [spring-flash-16](./spring-flash-16) - 🚨 Authentication
16. [spring-flash-17](./spring-flash-17) - 🧞‍♂️ User details manager
17. [spring-flash-18](./spring-flash-18) - ✂️ AOP Throwables
18. [spring-flash-19](./spring-flash-19) - 🎫 Transaction
19. [spring-flash-20](./spring-flash-20) - 🌏 CORS via XML

...
public class LyricAspect {
    ...
    @AfterThrowing(value = "execution(* org.jesperancinha.spring.flash18.aop.afterthrowing.service.impl.LyricsService.*(..))",
            throwing = "ex")
    public void afterThrowingAdvice(JoinPoint joinPoint, Exception ex) {
        joinPointService.afterThrowingAdvice(joinPoint, ex);
    }

    @AfterThrowing(value = "execution(* org.jesperancinha.spring.flash18.aop.afterthrowing.service.impl.LyricsService.enumerateLyric1(..))",
            throwing = "ex")
    public void afterThrowingAdvice1(JoinPoint joinPoint, Exception ex) {
        joinPointService.afterThrowingAdvice1(joinPoint, ex);
    }

    @AfterThrowing(value = "execution(* org.jesperancinha.spring.flash18.aop.afterthrowing.service.impl.LyricsService.enumerateLyric2(..))",
            throwing = "ex")
    public void afterThrowingAdvice2(JoinPoint joinPoint, Exception ex) {
        joinPointService.afterThrowingAdvice2(joinPoint, ex);
    }

    @AfterThrowing(value = "execution(* org.jesperancinha.spring.flash18.aop.afterthrowing.service.impl.LyricsService.enumerateLyric3(..))",
            throwing = "ex")
    public void afterThrowingAdvice3(JoinPoint joinPoint, Exception ex) {
        joinPointService.afterThrowingAdvice3(joinPoint, ex);
    }

    @AfterThrowing(value = "execution(* org.jesperancinha.spring.flash18.aop.afterthrowing.service.impl.LyricsService.resultLyric*(..))",
            throwing = "ex")

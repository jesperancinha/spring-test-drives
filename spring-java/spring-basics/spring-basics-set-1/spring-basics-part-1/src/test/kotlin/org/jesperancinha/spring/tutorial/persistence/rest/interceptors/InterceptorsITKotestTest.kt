...
@ContextConfiguration(classes = [WineController::class, InterceptorConfiguration::class, FeelingLoveBean::class])
internal class InterceptorsITKotestTest @Autowired constructor(
    ...
    fun testGetStringWhenCalledThenTriggerInterceptors() {
        ...
        handlers
            ...
            .forEach {
                it.shouldNotBeNull()
                    .toString() shouldBe "org.jesperancinha.spring.tutorial.persistence.rest.controller.WineController#getString()"
            }
    }
}
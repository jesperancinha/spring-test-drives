package org.jesperancinha.spring.flash59.aop.aspects;
...
public class IngredientAspect {
    ...
    @Around("execution(* org.jesperancinha.spring.flash59.aop.service.Recipe.bake())")
    ...
    @Around("@annotation(org.jesperancinha.spring.flash59.aop.annotation.Diet)")
    ...
    @Before("execution(* org.jesperancinha.spring.flash59.aop.service.Recipe.bake())")
    ...
    @After("execution(* org.jesperancinha.spring.flash59.aop.service.Recipe.bake())")

...
Exploring SpringBootContextLoader for Testing in Spring

1.  `SpringBootContextLoader`, `CacheAwareContextLoaderDelegate`, `BootstrapContext`, `SpringBootTestContextBootstrapper`, `MergedContextConfiguration`, `AssertableApplicationContext`

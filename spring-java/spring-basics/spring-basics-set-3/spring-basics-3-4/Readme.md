...
1.  [http://localhost:8080/spring-basics-3-4/carpenters/](http://localhost:8080/spring-basics-3-4/carpenters)

```bash
curl http://localhost:8080/spring-basics-3-4/carpenters
```
